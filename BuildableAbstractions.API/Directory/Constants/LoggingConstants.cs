...
internal static class LoggingConstants
{
    ...
    public const string BarricadeLoadProgress = "Loading Barricades from all regions on the map... {0}% [{1}/{2}] {3}ms";
    public const string LoadingStructures = "Registering and tracking all structures...";
    public const string StructureLoadProgress = "Loading Structures from all regions on the map... {0}% [{1}/{2}] {3}ms";
