...
{
    /// <summary>
    ///     Gets the <see cref="IBuildableDirectory" /> service currently in use. If none is in use,
    ///     <see cref="DefaultBuildableDirectory" /> will be instantiated and registered.
    /// </summary>
