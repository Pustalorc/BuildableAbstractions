...
using System.Linq;
using Pustalorc.Libraries.BuildableAbstractions.Actions;
...
public sealed class WreckCommand : IRocketCommand
{
    ...
    public void Execute(IRocketPlayer caller, string[] command)
    {
        ...
        if (confirm)
        {
            ...
            var remove = InstancedBuildableDirectory.GetBuildables(includePlants: action.IncludeVehicles);
        ...
        var builds = InstancedBuildableDirectory.GetBuildables(includePlants: plants);
